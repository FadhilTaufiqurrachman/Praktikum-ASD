        ...
        do {
            ...
            switch (app.menu) {
                ...
                case 5:
                    ...
                    String cariNamaDosen = input.nextLine();
                    data.PencarianDataSequential08(cariNamaDosen);
                    break;
                case 6:
                    System.out.print("Masukkan Usia Dosen yang dicari : ");
                    int cariUsiaDosen = input.nextInt();
                    data.sortingASC();
                    data.pencarianDataBinary08(cariUsiaDosen);
                    break;
                case 7:
